...
const featuredProjects = [
    {
        name: "eous-web-v0",
        description: "Personal website, currently running v2.",
        language: "TypeScript",
...
export function Homepage() {
    ...
    return <div className="homepage">
        <section className="hybrid-hero" aria-labelledby="homepage-title">
                <div className="hybrid-hero-copy">
                    <div className="hybrid-hero-heading">
                        <h1 id="homepage-title">Art, worlds<br/>and software.</h1>
        ...
        <section className="hybrid-index" aria-label="Explore the site">
                <div className="hybrid-index-intro">
                    <h2>quiet life or a<br/>blaze of glory?</h2>
                    <p>dunno, I still quite cant figured that out.</p>
                </div>
